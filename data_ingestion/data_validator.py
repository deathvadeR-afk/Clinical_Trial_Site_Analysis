...
class DataValidator:
    ...
    def create_data_quality_report(self) -> Dict[str, Any]:
        ...
        try:
            ...
            tables_to_check = [
                {'name': 'clinical_trials', 'required_fields': ['nct_id', 'title', 'status']},
                {'name': 'sites_master', 'required_fields': ['site_name', 'city', 'country']},
    ...
    def build_data_profiling_module(self) -> Dict[str, Any]:
        ...
        try:
            ...
            for table in tables:
                # Get record count
                count_result = self.db_manager.query(f"SELECT COUNT(*) as count FROM {table}")
                ...
                if table == 'clinical_trials':
                    ...
                    """)
                    profiling_report['field_distributions']['investigators_by_h_index'] = [
