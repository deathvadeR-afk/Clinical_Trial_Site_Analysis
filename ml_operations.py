    ...
    try:
        ...
        if results.get("training_success", False):
            ...
            if performance:
                ...
                print(f"Mean Squared Error: {performance.get('mean_squared_error', 'N/A')}")
                print(f"Root Mean Squared Error: {performance.get('root_mean_squared_error', 'N/A')}")
                print(f"Mean Absolute Error: {performance.get('mean_absolute_error', 'N/A')}")
                print(f"Mean Absolute Percentage Error: {performance.get('mean_absolute_percentage_error', 'N/A')}")
    ...
    try:
        ...
        if results:
            ...
            if cluster_characteristics:
                print(f"Number of cluster characteristics: {len(cluster_characteristics)}")
