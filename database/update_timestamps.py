...
def update_timestamps():
    ...
    try:
        ...
        cursor.execute("UPDATE sites_master SET last_updated = ? WHERE last_updated IS NULL", (current_time,))
        updated_sites = cursor.rowcount
        
        # Update clinical_trials table
        cursor.execute("UPDATE clinical_trials SET last_update_posted = ? WHERE last_update_posted IS NULL", (current_time,))
