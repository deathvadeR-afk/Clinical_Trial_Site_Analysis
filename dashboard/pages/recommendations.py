...
def fetch_top_sites_by_match_score(condition="", phase="", intervention_type="", country_preference=""):
...
def show_recommendations_page():
    ...
    if st.button("Generate Recommendations"):
        ...
        recommendations = fetch_top_sites_by_match_score(condition, phase, intervention_type, country_preference)
        ...
        if recommendations:
            ...
            st.dataframe(detailed_df[['Site', 'Therapeutic Match', 'Phase Match', 'Intervention Match', 'Geographic Match']], use_container_width=True)
        else:
            st.info("No recommendations found. Try adjusting your criteria or check back later as more data is ingested.")
